...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel,MainAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView")final int position, @NonNull MainModel model) {
        ...
        holder.lost.setText(model.getLost());
        holder.oname.setText(model.getOname());
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lost.setText(model.getLost());
                purl.setText(model.getPurl());
                oname.setText(model.getOname());
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        CircleImageView img;
        TextView name,gender,breed,lost,oname,phone,address,description;
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            name = (TextView)itemView.findViewById(R.id.petnametext);
            gender = (TextView)itemView.findViewById(R.id.gendertext);
            breed = (TextView)itemView.findViewById(R.id.breedtext);
            lost = (TextView)itemView.findViewById(R.id.losttext);
            oname = (TextView)itemView.findViewById(R.id.ownertext);
            phone= (TextView)itemView.findViewById(R.id.phonetext);
            address = (TextView)itemView.findViewById(R.id.addresstext);
            description= (TextView)itemView.findViewById(R.id.desptext);
